        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 pt-6">
              <a
                href="https://github.com/sahillansarii001"
                target="_blank"
                className="w-12 h-12 bg-white border border-gray-300 rounded-full flex items-center justify-center hover:border-cyan-500 hover:text-cyan-500 transition-all"
              >
              ...
              <a
                ...
                target="_blank"
                className="w-12 h-12 bg-white border border-gray-300 rounded-full flex items-center justify-center hover:border-blue-600 hover:text-blue-600 transition-all"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                className="w-12 h-12 bg-white border border-gray-300 rounded-full flex items-center justify-center hover:border-pink-500 hover:text-pink-500 transition-all"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="relative">
            <div className="relative z-10">
              <div className="w-full h-96 bg-linear-to-br from-cyan-400 via-purple-500 to-pink-500 rounded-3xl shadow-2xl transform rotate-3"></div>
              <div className="absolute inset-0 w-full h-96 bg-linear-to-br from-purple-400 via-pink-500 to-red-500 rounded-3xl shadow-2xl transform -rotate-3"></div>

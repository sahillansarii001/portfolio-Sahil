      ...
      <section id="projects" className="py-20 bg-slate-50" ref={ref}>
        <div className="max-w-6xl mx-auto px-6">
          ...
          <AnimatePresence>
            {showMobileFilter && (
              <motion.div
                className="md:hidden mb-8 bg-white rounded-lg shadow-lg p-4 space-y-2"
          ...
          <AnimatePresence>
            {selectedProject && (
              ...
              >
                <motion.div
                  className="relative bg-white rounded-3xl max-w-xl w-full max-h-[90vh] overflow-y-auto shadow-2xl [&::-webkit-scrollbar]:hidden"

    ...
    <>
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        {selectedProject && (
          ...
          >
            <div
              className="relative bg-white rounded-3xl max-w-xl w-full max-h-[90vh] overflow-y-auto shadow-2xl scrollbar-hide"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Close Button */}
              <div className="sticky top-2 w-full flex justify-end p-4 z-20 pointer-events-none">
                <button
                  onClick={() => setSelectedProject(null)}
                  className="w-12 h-12 bg-white/95 backdrop-blur-sm rounded-full shadow-lg flex items-center justify-center hover:bg-gray-100 transition-colors pointer-events-auto border border-gray-200"
                >
                  <svg
              ...
              {/* Project Image */}
              <div className="relative overflow-hidden rounded-t-3xl -mt-16 pt-16">
                <img
